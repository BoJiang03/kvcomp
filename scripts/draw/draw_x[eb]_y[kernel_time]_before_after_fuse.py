...
figures_path = "../final_figure/eb_multi_fuse_kernel_time/"
...
for ctx_len in context_lengths:
    ...
    for setting, result in rt:
        ...
        k_multi_kernel_time.append(result["k_time_multi_kernels"] + result["k_pytorch_mat_vec_mul_times"])
        v_multi_kernel_time.append(result["v_time_multi_kernels"] + result["v_pytorch_mat_vec_mul_times"])
    ...
    draw_two_lines_pic(kvcomp_quant_scale_rels, k_multi_kernel_time, k_single_kernel_time, f"Kernel Time", k_save_path,
                       label1="multi_kernel", label2="single_kernel")
    draw_two_lines_pic(kvcomp_quant_scale_rels, v_multi_kernel_time, v_single_kernel_time, f"Kernel Time", v_save_path,
                       label1="multi_kernel", label2="single_kernel")
