...
def filter_accuracy_result_map(accuracy_result_map: Dict[str, float], setting_map: Dict[str, Tuple[str, KVCompCacheConfig]]):
    total = 0
...
for setting_path, accuracy_result_path in zip(setting_paths, accuracy_result_paths):
    ...
    filter_accuracy_result_map(accuracy_result_map, setting_map)
