...
block_size = 64
k_quant_scale_rel = 0.02
for v_quant_scale_rel in np.arange(0.05, 0.35, 0.02).tolist():
    logger.info(f"k_quant_scale_rel: {k_quant_scale_rel}, v_quant_scale_rel: {v_quant_scale_rel}")
